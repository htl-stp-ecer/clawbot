...
class Defs:
    ...
    front_left_motor = Motor(
        ...
        calibration=MotorCalibration(
            ticks_to_rad=2.187956394029067e-05, vel_lpf_alpha=1.0
        ),
    )
    front_right_motor = Motor(
        ...
        inverted=True,
        calibration=MotorCalibration(
            ticks_to_rad=1.9983413766573743e-05, vel_lpf_alpha=1.0
        ),
    )
    rear_left_motor = Motor(
        ...
        inverted=False,
        calibration=MotorCalibration(
            ticks_to_rad=1.9573685137700873e-05, vel_lpf_alpha=1.0
        ),
    )
    rear_right_motor = Motor(
        ...
        inverted=True,
        calibration=MotorCalibration(
            ticks_to_rad=1.9233820750407518e-05, vel_lpf_alpha=1.0
        ),
    )
